...
public class Mbti_Esfp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatview_mbti.setText("ESFP"); //채팅방 입장과 동시에 챗봇 mbti 이름 변경
        chatview_img.setImageResource(R.drawable.esfp_name); //채팅방 입장과 동시에 챗봇 mbti 이미지 변경
    ...
    public void dialogShow2(){
        CustomDialog_MBTI_Text dlg2 = new CustomDialog_MBTI_Text(Mbti_Esfp.this);
        dlg2.show();
